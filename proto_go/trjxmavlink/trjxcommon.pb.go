...
// 	protoc        v3.19.4
// source: github.com/trajectoryjp/trjx-vehicle-api/proto/mav_controller_outside/trjxcommon.proto
...
func (x *SystemVersion) Reset() {
	*x = SystemVersion{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_trajectoryjp_trjx_vehicle_api_proto_mav_controller_outside_trjxcommon_proto_msgTypes[0]
...
func (*SystemVersion) Descriptor() ([]byte, []int) {
	return file_github_com_trajectoryjp_trjx_vehicle_api_proto_mav_controller_outside_trjxcommon_proto_rawDescGZIP(), []int{0}
}
...
func (x *SeriviceAttribute) Reset() {
	*x = SeriviceAttribute{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_trajectoryjp_trjx_vehicle_api_proto_mav_controller_outside_trjxcommon_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SeriviceAttribute) Descriptor() ([]byte, []int) {
	return file_github_com_trajectoryjp_trjx_vehicle_api_proto_mav_controller_outside_trjxcommon_proto_rawDescGZIP(), []int{1}
}
...
func (x *Empty) Reset() {
	*x = Empty{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_trajectoryjp_trjx_vehicle_api_proto_mav_controller_outside_trjxcommon_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
var File_github_com_trajectoryjp_trjx_vehicle_api_proto_mav_controller_outside_trjxcommon_proto protoreflect.FileDescriptor

var file_github_com_trajectoryjp_trjx_vehicle_api_proto_mav_controller_outside_trjxcommon_proto_rawDesc = []byte{
	0x0a, 0x56, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x74, 0x72, 0x61,
	...
	0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0b, 0x74, 0x72, 0x6a, 0x78, 0x6d, 0x61,
	0x76, 0x6c, 0x69, 0x6e, 0x6b, 0x22, 0x51, 0x0a, 0x0d, 0x53, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x56,
	...
	0x09, 0x52, 0x05, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x22, 0x49, 0x0a, 0x11, 0x53, 0x65, 0x72, 0x69,
	0x76, 0x69, 0x63, 0x65, 0x41, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x12, 0x34, 0x0a,
...
var (
	file_github_com_trajectoryjp_trjx_vehicle_api_proto_mav_controller_outside_trjxcommon_proto_rawDescOnce sync.Once
	file_github_com_trajectoryjp_trjx_vehicle_api_proto_mav_controller_outside_trjxcommon_proto_rawDescData = file_github_com_trajectoryjp_trjx_vehicle_api_proto_mav_controller_outside_trjxcommon_proto_rawDesc
)

func file_github_com_trajectoryjp_trjx_vehicle_api_proto_mav_controller_outside_trjxcommon_proto_rawDescGZIP() []byte {
	file_github_com_trajectoryjp_trjx_vehicle_api_proto_mav_controller_outside_trjxcommon_proto_rawDescOnce.Do(func() {
		file_github_com_trajectoryjp_trjx_vehicle_api_proto_mav_controller_outside_trjxcommon_proto_rawDescData = protoimpl.X.CompressGZIP(file_github_com_trajectoryjp_trjx_vehicle_api_proto_mav_controller_outside_trjxcommon_proto_rawDescData)
	})
...
func file_github_com_trajectoryjp_trjx_vehicle_api_proto_mav_controller_outside_trjxcommon_proto_init() {
	if File_github_com_trajectoryjp_trjx_vehicle_api_proto_mav_controller_outside_trjxcommon_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_github_com_trajectoryjp_trjx_vehicle_api_proto_mav_controller_outside_trjxcommon_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_trajectoryjp_trjx_vehicle_api_proto_mav_controller_outside_trjxcommon_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_trajectoryjp_trjx_vehicle_api_proto_mav_controller_outside_trjxcommon_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Empty); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_github_com_trajectoryjp_trjx_vehicle_api_proto_mav_controller_outside_trjxcommon_proto_goTypes,
		DependencyIndexes: file_github_com_trajectoryjp_trjx_vehicle_api_proto_mav_controller_outside_trjxcommon_proto_depIdxs,
		EnumInfos:         file_github_com_trajectoryjp_trjx_vehicle_api_proto_mav_controller_outside_trjxcommon_proto_enumTypes,
		MessageInfos:      file_github_com_trajectoryjp_trjx_vehicle_api_proto_mav_controller_outside_trjxcommon_proto_msgTypes,
	}.Build()
	File_github_com_trajectoryjp_trjx_vehicle_api_proto_mav_controller_outside_trjxcommon_proto = out.File
	file_github_com_trajectoryjp_trjx_vehicle_api_proto_mav_controller_outside_trjxcommon_proto_rawDesc = nil
	file_github_com_trajectoryjp_trjx_vehicle_api_proto_mav_controller_outside_trjxcommon_proto_goTypes = nil
	file_github_com_trajectoryjp_trjx_vehicle_api_proto_mav_controller_outside_trjxcommon_proto_depIdxs = nil
}
